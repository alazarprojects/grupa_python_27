...
# == in cazul asta nu verifica si idenitatea acelor variabile
print(var9 == var10)
...
varlist2 = [10, 30, 45, 99, -1, 0, -99, 252321425, "hello", "a", True, 0.5, type(0)]
print(varlist2)

varlist3 = [100, 200,[-1, -3, -10, [-99, -88, 0]], [True], var3, var10]
print(varlist3)
